...
var FrameView = function () {
	...
	_createClass(FrameView, [{
		key: 'render',
		value: function render(layout, urls, title) {
			if (!urls) {
				return;
			}
			...
			this.$root.empty().removeClass('layout-' + this.$root.attr('data-layout-class')).addClass('layout-' + layout).attr('data-layout-class', layout);

			this.$root.append((0, _jquery2.default)(urls).map(function (index, url) {
				return (0, _jquery2.default)('<iframe>').attr('src', url).addClass('item item-' + (index + 1))[0];
			}));
...
var view = new FrameView((0, _jquery2.default)('.container .layout'));
...
//# sourceMappingURL=/src.ab2c4566.map